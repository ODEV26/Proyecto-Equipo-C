...
class LPR:
    def __init__(self, min_w=80, max_w=110, min_h=25, max_h=52, ratio=2.06):
        self.min_w = min_w
        self.max_w = max_w
        self.min_h = min_h
        self.max_h = max_h
    ...
    def apply_adaptive_threshold(self, img):
        return cv2.adaptiveThreshold(img, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY_INV, 5, 33)
    ...
    def read_license(self, img, psm=7):
        ...
        if candidates:
            ...
            return "No se ha detectado la matricula"